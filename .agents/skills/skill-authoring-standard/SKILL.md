...
> [!NOTE]
> All named execution skills and resource paths in this example are hypothetical. The repository currently contains `skill-authoring-standard` and `task-framing`.
